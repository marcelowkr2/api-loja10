  ...
  return (
    <div className='bg-bege-100'>
        <div className="container m-auto w-10/12">
            ...
            <Questions number='5' title='Quando posso esperar que meu pedido chegue?' text='Não trabalhamos com pronta entrega. Em média, os pedidos levam de 5 a 7 dias, mediante o adiantamento do 50% do valor. O prazo de entrega pode variar de acordo com o CEP. Qualquer exceção será explicitamente escrita na página de descrição do produto. Quaisquer problemas inesperados após o envio do item serão informados no nosso canal de compras.'/>
            ...
            <Questions number='7' title='Posso cancelar ou modificar meu pedido?' text='Sim, embora seu pedido seja enviado imediatamente após o atendimento, caso ainda não tiver sido, pode haver o cancelamento ou modificação. Se já foi, os custos de devolução ficam por conta do cliente. Entre em contato conosco imediatamente nesses casos. Nós nos reservamos o direito de cancelar um pedido a qualquer momento antes de ter despachado e reembolsar integralmente o valor cobrado.'/>
            <Questions number='8' title='Caso eu tenha inserido um endereço errado, é possível reenviar o meu pedido?' text='Se o seu pedido ainda não tiver sido entregue à transportadora, envie uma mensagem o quanto antes para nós com o endereço correto.'/>
        </div>
    </div>
  );
}
